...
public class StandardizedProjectileForHandBool : MonoBehaviour
{
    ...
    [HideInInspector]
    public StandardizedBowForHandBool bowScript;
    [HideInInspector]
    ...
    void Start()
    {
        ...
        if (bowScript == null)
        {
            ...
            bowScript = GetComponentInParent<StandardizedBowForHandBool>();
        }
        ...
        if (transform.parent == null)
        {
            ...
            else
            {
                if (!collisionHappened)
                {
                    ...
                    transform.rotation = Quaternion.LookRotation(rigid.linearVelocity);
                }
            }
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (contactHash == fleshHash)
        {
            ...
            if (projectileHitParticleFlesh != null)
            {
                ...
                burstControl.count = Mathf.FloorToInt(rigid.linearVelocity.magnitude * effectOfVelocityOnParticleEmission);
